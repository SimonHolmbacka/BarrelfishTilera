...
static  errval_t monitor_bind_udn_client_request__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, iref_t iref, uintptr_t conn_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // call rx handler
    assert(((_binding->rx_vtbl).bind_udn_client_request) != NULL);
    ((_binding->rx_vtbl).bind_udn_client_request)(_binding, iref, conn_id, notify, core_id, chan_id, asid);
...
static  errval_t monitor_bind_udn_service_request__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t service_id, uintptr_t mon_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // call rx handler
    assert(((_binding->rx_vtbl).bind_udn_service_request) != NULL);
    ((_binding->rx_vtbl).bind_udn_service_request)(_binding, service_id, mon_id, notify, core_id, chan_id, asid);
...
static  errval_t monitor_bind_udn_reply_monitor__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // call rx handler
    assert(((_binding->rx_vtbl).bind_udn_reply_monitor) != NULL);
    ((_binding->rx_vtbl).bind_udn_reply_monitor)(_binding, mon_id, conn_id, err, notify, core_id, chan_id, asid);
...
static  errval_t monitor_bind_udn_reply_client__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // call rx handler
    assert(((_binding->rx_vtbl).bind_udn_reply_client) != NULL);
    ((_binding->rx_vtbl).bind_udn_reply_client)(_binding, mon_id, conn_id, err, notify, core_id, chan_id, asid);
...
static  struct monitor_tx_vtbl monitor_loopback_tx_vtbl = {
    ...
    .bind_udn_client_request = monitor_bind_udn_client_request__loopback_send,
    .bind_udn_service_request = monitor_bind_udn_service_request__loopback_send,
    .bind_udn_reply_monitor = monitor_bind_udn_reply_monitor__loopback_send,
    .bind_udn_reply_client = monitor_bind_udn_reply_client__loopback_send,
