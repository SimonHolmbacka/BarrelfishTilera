 ...
 * INTEFACE FILE: /home/andreas/barrelfish/new_test2/if/monitor_blocking.if
...
static  void monitor_blocking_remote_cap_retype_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send7(&(b->chan), b->flags, ((_binding->tx_union).remote_cap_retype_call).croot, monitor_blocking_remote_cap_retype_call__msgnum | (((uintptr_t )(((_binding->tx_union).remote_cap_retype_call).size_bits)) << 16), ((_binding->tx_union).remote_cap_retype_call).src, ((_binding->tx_union).remote_cap_retype_call).objtype, (((_binding->tx_union).remote_cap_retype_call).objtype) >> 32, ((_binding->tx_union).remote_cap_retype_call).to, ((_binding->tx_union).remote_cap_retype_call).slot, ((_binding->tx_union).remote_cap_retype_call).dcn_vbits);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_remote_cap_delete_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, ((_binding->tx_union).remote_cap_delete_call).croot, monitor_blocking_remote_cap_delete_call__msgnum | (((uintptr_t )(((_binding->tx_union).remote_cap_delete_call).vbits)) << 16), ((_binding->tx_union).remote_cap_delete_call).src);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_remote_cap_revoke_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, ((_binding->tx_union).remote_cap_revoke_call).croot, monitor_blocking_remote_cap_revoke_call__msgnum | (((uintptr_t )(((_binding->tx_union).remote_cap_revoke_call).vbits)) << 16), ((_binding->tx_union).remote_cap_revoke_call).src);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_rsrc_manifest_response__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, NULL_CAP, monitor_blocking_rsrc_manifest_response__msgnum, ((_binding->tx_union).rsrc_manifest_response).id, ((_binding->tx_union).rsrc_manifest_response).err);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_rsrc_join_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, ((_binding->tx_union).rsrc_join_call).dispatcher, monitor_blocking_rsrc_join_call__msgnum, ((_binding->tx_union).rsrc_join_call).id);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_rsrc_phase_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, NULL_CAP, monitor_blocking_rsrc_phase_call__msgnum, ((_binding->tx_union).rsrc_phase_call).id, ((_binding->tx_union).rsrc_phase_call).phase);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_cap_identify_response__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send7(&(b->chan), (b->flags) & (~LMP_FLAG_SYNC), NULL_CAP, monitor_blocking_cap_identify_response__msgnum, ((_binding->tx_union).cap_identify_response).err, (((_binding->tx_union).cap_identify_response).caprep).w0, ((((_binding->tx_union).cap_identify_response).caprep).w0) >> 32, (((_binding->tx_union).cap_identify_response).caprep).w1, ((((_binding->tx_union).cap_identify_response).caprep).w1) >> 32, (((_binding->tx_union).cap_identify_response).caprep).w2);
        if (err_is_ok(err)) {
            (_binding->tx_msg_fragment)++;
            // fall through to next fragment
        } else {
    ...
    case 1:
        err = lmp_chan_send3(&(b->chan), b->flags, NULL_CAP, ((((_binding->tx_union).cap_identify_response).caprep).w2) >> 32, (((_binding->tx_union).cap_identify_response).caprep).w3, ((((_binding->tx_union).cap_identify_response).caprep).w3) >> 32);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_irq_handle_response__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, NULL_CAP, monitor_blocking_irq_handle_response__msgnum, ((_binding->tx_union).irq_handle_response).err, ((_binding->tx_union).irq_handle_response).vector);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_blocking_dump_hw_ptables_call__lmp_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct monitor_blocking_binding *_binding = arg;
    struct monitor_blocking_lmp_binding *b = arg;
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send1(&(b->chan), b->flags, ((_binding->tx_union).dump_hw_ptables_call).dispatcher, monitor_blocking_dump_hw_ptables_call__msgnum);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    if (lmp_err_is_transient(err)) {
        // Construct retry closure and register it
        struct event_closure retry_closure = (struct event_closure){  .handler = monitor_blocking_dump_hw_ptables_call__lmp_send_handler,  .arg = arg };
        err = lmp_chan_register_send(&(b->chan), _binding->waitset, retry_closure);
        assert(err_is_ok(err));
    } else {
        // Report error to user
...
static  void monitor_blocking_dump_hw_ptables_response__lmp_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct monitor_blocking_binding *_binding = arg;
    struct monitor_blocking_lmp_binding *b = arg;
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send1(&(b->chan), b->flags, NULL_CAP, monitor_blocking_dump_hw_ptables_response__msgnum);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    if (lmp_err_is_transient(err)) {
        // Construct retry closure and register it
        struct event_closure retry_closure = (struct event_closure){  .handler = monitor_blocking_dump_hw_ptables_response__lmp_send_handler,  .arg = arg };
        err = lmp_chan_register_send(&(b->chan), _binding->waitset, retry_closure);
        assert(err_is_ok(err));
    } else {
        // Report error to user
...
static  errval_t monitor_blocking_dump_hw_ptables_call__lmp_send(struct monitor_blocking_binding *_binding, struct event_closure _continuation, struct capref dispatcher)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    // store message number and arguments
    _binding->tx_msgnum = monitor_blocking_dump_hw_ptables_call__msgnum;
    _binding->tx_msg_fragment = 0;
    ((_binding->tx_union).dump_hw_ptables_call).dispatcher = dispatcher;
    FL_DEBUG("lmp TX monitor_blocking.dump_hw_ptables_call\n");
    
    // try to send!
    monitor_blocking_dump_hw_ptables_call__lmp_send_handler(_binding);
    
    return(SYS_ERR_OK);
}

static  errval_t monitor_blocking_dump_hw_ptables_response__lmp_send(struct monitor_blocking_binding *_binding, struct event_closure _continuation)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    // store message number and arguments
    _binding->tx_msgnum = monitor_blocking_dump_hw_ptables_response__msgnum;
    _binding->tx_msg_fragment = 0;
    FL_DEBUG("lmp TX monitor_blocking.dump_hw_ptables_response\n");
    
    // try to send!
    monitor_blocking_dump_hw_ptables_response__lmp_send_handler(_binding);
...
static  struct monitor_blocking_tx_vtbl monitor_blocking_lmp_tx_vtbl = {
    ...
    .dump_hw_ptables_call = monitor_blocking_dump_hw_ptables_call__lmp_send,
    .dump_hw_ptables_response = monitor_blocking_dump_hw_ptables_response__lmp_send,
};
/*
 * Receive handler
 */
    ...
    do {
        ...
        case monitor_blocking_remote_cap_retype_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).remote_cap_retype_call).src = ((msg.words)[1]);
                ((_binding->rx_union).remote_cap_retype_call).objtype = ((msg.words)[2]);
                ((_binding->rx_union).remote_cap_retype_call).objtype = ((((_binding->rx_union).remote_cap_retype_call).objtype) | (((uint64_t )((msg.words)[3])) << 32));
                ((_binding->rx_union).remote_cap_retype_call).to = ((msg.words)[4]);
                ((_binding->rx_union).remote_cap_retype_call).slot = ((msg.words)[5]);
                ((_binding->rx_union).remote_cap_retype_call).dcn_vbits = ((msg.words)[6]);
        ...
        case monitor_blocking_remote_cap_delete_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).remote_cap_delete_call).src = ((msg.words)[1]);
        ...
        case monitor_blocking_remote_cap_revoke_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).remote_cap_revoke_call).src = ((msg.words)[1]);
        ...
        case monitor_blocking_rsrc_manifest_response__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).rsrc_manifest_response).id = ((msg.words)[1]);
                ((_binding->rx_union).rsrc_manifest_response).err = ((msg.words)[2]);
        ...
        case monitor_blocking_rsrc_join_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).rsrc_join_call).id = ((msg.words)[1]);
        ...
        case monitor_blocking_rsrc_phase_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).rsrc_phase_call).id = ((msg.words)[1]);
                ((_binding->rx_union).rsrc_phase_call).phase = ((msg.words)[2]);
        ...
        case monitor_blocking_cap_identify_response__msgnum:
            ...
            case 0:
                ...
                (((_binding->rx_union).cap_identify_response).caprep).w0 = (((((_binding->rx_union).cap_identify_response).caprep).w0) | (((uint64_t )((msg.words)[3])) << 32));
                (((_binding->rx_union).cap_identify_response).caprep).w1 = ((msg.words)[4]);
                (((_binding->rx_union).cap_identify_response).caprep).w1 = (((((_binding->rx_union).cap_identify_response).caprep).w1) | (((uint64_t )((msg.words)[5])) << 32));
                (((_binding->rx_union).cap_identify_response).caprep).w2 = ((msg.words)[6]);
            ...
            case 1:
                ...
                (((_binding->rx_union).cap_identify_response).caprep).w2 = (((((_binding->rx_union).cap_identify_response).caprep).w2) | (((uint64_t )((msg.words)[0])) << 32));
                (((_binding->rx_union).cap_identify_response).caprep).w3 = ((msg.words)[1]);
                (((_binding->rx_union).cap_identify_response).caprep).w3 = (((((_binding->rx_union).cap_identify_response).caprep).w3) | (((uint64_t )((msg.words)[2])) << 32));
        ...
        case monitor_blocking_irq_handle_response__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).irq_handle_response).vector = ((msg.words)[2]);
        ...
        case monitor_blocking_get_arch_core_id_response__msgnum:
            ...
            break;
        case monitor_blocking_dump_hw_ptables_call__msgnum:
            switch (_binding->rx_msg_fragment) {
            case 0:
                // check length
                if (((msg.buf).msglen) != 1) {
                ...
                ((_binding->rx_union).dump_hw_ptables_call).dispatcher = cap;
                
                FL_DEBUG("lmp RX monitor_blocking.dump_hw_ptables_call\n");
                assert(((_binding->rx_vtbl).dump_hw_ptables_call) != NULL);
                ((_binding->rx_vtbl).dump_hw_ptables_call)(_binding, ((_binding->rx_union).dump_hw_ptables_call).dispatcher);
                _binding->rx_msgnum = 0;
                break;
            default:
                (_binding->error_handler)(_binding, FLOUNDER_ERR_INVALID_STATE);
            ...
            break;
        case monitor_blocking_dump_hw_ptables_response__msgnum:
            switch (_binding->rx_msg_fragment) {
            case 0:
                // check length
                if (((msg.buf).msglen) != 1) {
                ...
                FL_DEBUG("lmp RX monitor_blocking.dump_hw_ptables_response\n");
                assert(((_binding->rx_vtbl).dump_hw_ptables_response) != NULL);
                ((_binding->rx_vtbl).dump_hw_ptables_response)(_binding);
                _binding->rx_msgnum = 0;
                break;
            default:
                (_binding->error_handler)(_binding, FLOUNDER_ERR_INVALID_STATE);
...
static  errval_t monitor_blocking_dump_hw_ptables__rpc(struct monitor_blocking_rpc_client *_rpc, struct capref dispatcher)
{
    errval_t _err = SYS_ERR_OK;
    assert(!(_rpc->rpc_in_progress));
    assert((_rpc->async_error) == SYS_ERR_OK);
    ...
    // call send function
    _err = ((((_rpc->b)->tx_vtbl).dump_hw_ptables_call)(_rpc->b, NOP_CONT, dispatcher));
    if (err_is_fail(_err)) {
        goto out;
    }
...
static  void monitor_blocking_dump_hw_ptables__rpc_rx_handler(struct monitor_blocking_binding *_binding)
{
    // get RPC client state pointer
    struct monitor_blocking_rpc_client *_rpc = _binding->st;
...
static  struct monitor_blocking_rpc_vtbl monitor_blocking_rpc_vtbl = {
    ...
    .dump_hw_ptables = monitor_blocking_dump_hw_ptables__rpc,
};
 ...
 errval_t monitor_blocking_rpc_client_init(struct monitor_blocking_rpc_client *rpc, struct monitor_blocking_binding *binding)
{
    ...
    (binding->rx_vtbl).dump_hw_ptables_response = monitor_blocking_dump_hw_ptables__rpc_rx_handler;
