...
static  void monitor_alloc_iref_reply__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send4(&(b->chan), b->flags, NULL_CAP, monitor_alloc_iref_reply__msgnum, ((_binding->tx_union).alloc_iref_reply).service_id, ((_binding->tx_union).alloc_iref_reply).iref, ((_binding->tx_union).alloc_iref_reply).err);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_boot_core_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), (b->flags) & (~LMP_FLAG_SYNC), NULL_CAP, monitor_boot_core_request__msgnum | (((uintptr_t )(((_binding->tx_union).boot_core_request).id)) << 16), ((_binding->tx_union).boot_core_request).hwid, ((_binding->tx_union).boot_core_request).type);
        if (err_is_ok(err)) {
...
static  void monitor_bind_lmp_client_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send4(&(b->chan), b->flags, ((_binding->tx_union).bind_lmp_client_request).ep, monitor_bind_lmp_client_request__msgnum, ((_binding->tx_union).bind_lmp_client_request).iref, ((_binding->tx_union).bind_lmp_client_request).conn_id, ((_binding->tx_union).bind_lmp_client_request).buflen);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_multiboot_cap_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, NULL_CAP, monitor_multiboot_cap_request__msgnum, ((_binding->tx_union).multiboot_cap_request).slot);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_bind_ump_client_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send5(&(b->chan), (b->flags) & (~LMP_FLAG_SYNC), ((_binding->tx_union).bind_ump_client_request).frame, monitor_bind_ump_client_request__msgnum, ((_binding->tx_union).bind_ump_client_request).iref, ((_binding->tx_union).bind_ump_client_request).conn_id, ((_binding->tx_union).bind_ump_client_request).channel_length_in, ((_binding->tx_union).bind_ump_client_request).channel_length_out);
        if (err_is_ok(err)) {
            (_binding->tx_msg_fragment)++;
            // fall through to next fragment
        } else {
...
static  void monitor_bind_udn_client_request__lmp_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct monitor_binding *_binding = arg;
    struct monitor_lmp_binding *b = arg;
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send6(&(b->chan), b->flags, ((_binding->tx_union).bind_udn_client_request).notify, monitor_bind_udn_client_request__msgnum, ((_binding->tx_union).bind_udn_client_request).iref, ((_binding->tx_union).bind_udn_client_request).conn_id, ((_binding->tx_union).bind_udn_client_request).core_id, ((_binding->tx_union).bind_udn_client_request).chan_id, ((_binding->tx_union).bind_udn_client_request).asid);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    if (lmp_err_is_transient(err)) {
        // Construct retry closure and register it
        struct event_closure retry_closure = (struct event_closure){  .handler = monitor_bind_udn_client_request__lmp_send_handler,  .arg = arg };
        err = lmp_chan_register_send(&(b->chan), _binding->waitset, retry_closure);
        assert(err_is_ok(err));
    } else {
        // Report error to user
...
static  void monitor_bind_udn_service_request__lmp_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct monitor_binding *_binding = arg;
    struct monitor_lmp_binding *b = arg;
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send6(&(b->chan), b->flags, ((_binding->tx_union).bind_udn_service_request).notify, monitor_bind_udn_service_request__msgnum, ((_binding->tx_union).bind_udn_service_request).service_id, ((_binding->tx_union).bind_udn_service_request).mon_id, ((_binding->tx_union).bind_udn_service_request).core_id, ((_binding->tx_union).bind_udn_service_request).chan_id, ((_binding->tx_union).bind_udn_service_request).asid);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    if (lmp_err_is_transient(err)) {
        // Construct retry closure and register it
        struct event_closure retry_closure = (struct event_closure){  .handler = monitor_bind_udn_service_request__lmp_send_handler,  .arg = arg };
        err = lmp_chan_register_send(&(b->chan), _binding->waitset, retry_closure);
        assert(err_is_ok(err));
    } else {
        // Report error to user
...
static  void monitor_bind_udn_reply_monitor__lmp_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct monitor_binding *_binding = arg;
    struct monitor_lmp_binding *b = arg;
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send7(&(b->chan), b->flags, ((_binding->tx_union).bind_udn_reply_monitor).notify, monitor_bind_udn_reply_monitor__msgnum, ((_binding->tx_union).bind_udn_reply_monitor).mon_id, ((_binding->tx_union).bind_udn_reply_monitor).conn_id, ((_binding->tx_union).bind_udn_reply_monitor).err, ((_binding->tx_union).bind_udn_reply_monitor).core_id, ((_binding->tx_union).bind_udn_reply_monitor).chan_id, ((_binding->tx_union).bind_udn_reply_monitor).asid);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    if (lmp_err_is_transient(err)) {
        // Construct retry closure and register it
        struct event_closure retry_closure = (struct event_closure){  .handler = monitor_bind_udn_reply_monitor__lmp_send_handler,  .arg = arg };
        err = lmp_chan_register_send(&(b->chan), _binding->waitset, retry_closure);
        assert(err_is_ok(err));
    } else {
        // Report error to user
...
static  void monitor_bind_udn_reply_client__lmp_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct monitor_binding *_binding = arg;
    struct monitor_lmp_binding *b = arg;
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send7(&(b->chan), b->flags, ((_binding->tx_union).bind_udn_reply_client).notify, monitor_bind_udn_reply_client__msgnum, ((_binding->tx_union).bind_udn_reply_client).mon_id, ((_binding->tx_union).bind_udn_reply_client).conn_id, ((_binding->tx_union).bind_udn_reply_client).err, ((_binding->tx_union).bind_udn_reply_client).core_id, ((_binding->tx_union).bind_udn_reply_client).chan_id, ((_binding->tx_union).bind_udn_reply_client).asid);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    if (lmp_err_is_transient(err)) {
        // Construct retry closure and register it
        struct event_closure retry_closure = (struct event_closure){  .handler = monitor_bind_udn_reply_client__lmp_send_handler,  .arg = arg };
        err = lmp_chan_register_send(&(b->chan), _binding->waitset, retry_closure);
        assert(err_is_ok(err));
    } else {
        // Report error to user
...
static  void monitor_get_mem_iref_reply__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, NULL_CAP, monitor_get_mem_iref_reply__msgnum, ((_binding->tx_union).get_mem_iref_reply).iref);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_get_name_iref_reply__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, NULL_CAP, monitor_get_name_iref_reply__msgnum, ((_binding->tx_union).get_name_iref_reply).iref, ((_binding->tx_union).get_name_iref_reply).st);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_get_ramfs_iref_reply__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, NULL_CAP, monitor_get_ramfs_iref_reply__msgnum, ((_binding->tx_union).get_ramfs_iref_reply).iref, ((_binding->tx_union).get_ramfs_iref_reply).st);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_set_ramfs_iref_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, NULL_CAP, monitor_set_ramfs_iref_request__msgnum, ((_binding->tx_union).set_ramfs_iref_request).iref);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_set_mem_iref_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, NULL_CAP, monitor_set_mem_iref_request__msgnum, ((_binding->tx_union).set_mem_iref_request).iref);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_set_name_iref_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, NULL_CAP, monitor_set_name_iref_request__msgnum, ((_binding->tx_union).set_name_iref_request).iref);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_get_monitor_rpc_iref_reply__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, NULL_CAP, monitor_get_monitor_rpc_iref_reply__msgnum, ((_binding->tx_union).get_monitor_rpc_iref_reply).iref, ((_binding->tx_union).get_monitor_rpc_iref_reply).st);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_cap_send_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, ((_binding->tx_union).cap_send_request).cap, monitor_cap_send_request__msgnum | (((uintptr_t )(((_binding->tx_union).cap_send_request).give_away)) << 16), ((_binding->tx_union).cap_send_request).mon_id, ((_binding->tx_union).cap_send_request).capid);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_cap_receive_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send4(&(b->chan), b->flags, ((_binding->tx_union).cap_receive_request).cap, monitor_cap_receive_request__msgnum, ((_binding->tx_union).cap_receive_request).conn_id, ((_binding->tx_union).cap_receive_request).err, ((_binding->tx_union).cap_receive_request).capid);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_multihop_bind_client_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send4(&(b->chan), b->flags, NULL_CAP, monitor_multihop_bind_client_request__msgnum, ((_binding->tx_union).multihop_bind_client_request).iref, ((_binding->tx_union).multihop_bind_client_request).sender_vci, (((_binding->tx_union).multihop_bind_client_request).sender_vci) >> 32);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_multihop_bind_client_reply__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send6(&(b->chan), b->flags, NULL_CAP, monitor_multihop_bind_client_reply__msgnum, ((_binding->tx_union).multihop_bind_client_reply).receiver_vci, (((_binding->tx_union).multihop_bind_client_reply).receiver_vci) >> 32, ((_binding->tx_union).multihop_bind_client_reply).sender_vci, (((_binding->tx_union).multihop_bind_client_reply).sender_vci) >> 32, ((_binding->tx_union).multihop_bind_client_reply).err);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_multihop_bind_service_request__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send4(&(b->chan), b->flags, NULL_CAP, monitor_multihop_bind_service_request__msgnum, ((_binding->tx_union).multihop_bind_service_request).service_id, ((_binding->tx_union).multihop_bind_service_request).sender_vci, (((_binding->tx_union).multihop_bind_service_request).sender_vci) >> 32);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_multihop_bind_service_reply__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send6(&(b->chan), b->flags, NULL_CAP, monitor_multihop_bind_service_reply__msgnum, ((_binding->tx_union).multihop_bind_service_reply).receiver_vci, (((_binding->tx_union).multihop_bind_service_reply).receiver_vci) >> 32, ((_binding->tx_union).multihop_bind_service_reply).sender_vci, (((_binding->tx_union).multihop_bind_service_reply).sender_vci) >> 32, ((_binding->tx_union).multihop_bind_service_reply).err);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_multihop_message__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send4(&(b->chan), (b->flags) & (~LMP_FLAG_SYNC), NULL_CAP, monitor_multihop_message__msgnum | ((((uintptr_t )(((_binding->tx_union).multihop_message).direction)) << 16) | (((uintptr_t )(((_binding->tx_union).multihop_message).flags)) << 24)), ((_binding->tx_union).multihop_message).vci, (((_binding->tx_union).multihop_message).vci) >> 32, ((_binding->tx_union).multihop_message).ack);
        if (err_is_ok(err)) {
            (_binding->tx_msg_fragment)++;
            // fall through to next fragment
        } else {
...
static  void monitor_multihop_cap_send__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send5(&(b->chan), b->flags, ((_binding->tx_union).multihop_cap_send).cap, monitor_multihop_cap_send__msgnum | (((uintptr_t )(((_binding->tx_union).multihop_cap_send).direction)) << 16), ((_binding->tx_union).multihop_cap_send).vci, (((_binding->tx_union).multihop_cap_send).vci) >> 32, ((_binding->tx_union).multihop_cap_send).err, ((_binding->tx_union).multihop_cap_send).capid);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void monitor_bfscope_flush_send__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), b->flags, NULL_CAP, monitor_bfscope_flush_send__msgnum, ((_binding->tx_union).bfscope_flush_send).iref);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  errval_t monitor_bind_udn_client_request__lmp_send(struct monitor_binding *_binding, struct event_closure _continuation, iref_t iref, uintptr_t conn_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    // store message number and arguments
    _binding->tx_msgnum = monitor_bind_udn_client_request__msgnum;
    _binding->tx_msg_fragment = 0;
    ((_binding->tx_union).bind_udn_client_request).iref = iref;
    ((_binding->tx_union).bind_udn_client_request).conn_id = conn_id;
    ((_binding->tx_union).bind_udn_client_request).notify = notify;
    ((_binding->tx_union).bind_udn_client_request).core_id = core_id;
    ((_binding->tx_union).bind_udn_client_request).chan_id = chan_id;
    ((_binding->tx_union).bind_udn_client_request).asid = asid;
    FL_DEBUG("lmp TX monitor.bind_udn_client_request\n");
    
    // try to send!
    monitor_bind_udn_client_request__lmp_send_handler(_binding);
    
    return(SYS_ERR_OK);
}

static  errval_t monitor_bind_udn_service_request__lmp_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t service_id, uintptr_t mon_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    // store message number and arguments
    _binding->tx_msgnum = monitor_bind_udn_service_request__msgnum;
    _binding->tx_msg_fragment = 0;
    ((_binding->tx_union).bind_udn_service_request).service_id = service_id;
    ((_binding->tx_union).bind_udn_service_request).mon_id = mon_id;
    ((_binding->tx_union).bind_udn_service_request).notify = notify;
    ((_binding->tx_union).bind_udn_service_request).core_id = core_id;
    ((_binding->tx_union).bind_udn_service_request).chan_id = chan_id;
    ((_binding->tx_union).bind_udn_service_request).asid = asid;
    FL_DEBUG("lmp TX monitor.bind_udn_service_request\n");
    
    // try to send!
    monitor_bind_udn_service_request__lmp_send_handler(_binding);
    
    return(SYS_ERR_OK);
}

static  errval_t monitor_bind_udn_reply_monitor__lmp_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    // store message number and arguments
    _binding->tx_msgnum = monitor_bind_udn_reply_monitor__msgnum;
    _binding->tx_msg_fragment = 0;
    ((_binding->tx_union).bind_udn_reply_monitor).mon_id = mon_id;
    ((_binding->tx_union).bind_udn_reply_monitor).conn_id = conn_id;
    ((_binding->tx_union).bind_udn_reply_monitor).err = err;
    ((_binding->tx_union).bind_udn_reply_monitor).notify = notify;
    ((_binding->tx_union).bind_udn_reply_monitor).core_id = core_id;
    ((_binding->tx_union).bind_udn_reply_monitor).chan_id = chan_id;
    ((_binding->tx_union).bind_udn_reply_monitor).asid = asid;
    FL_DEBUG("lmp TX monitor.bind_udn_reply_monitor\n");
    
    // try to send!
    monitor_bind_udn_reply_monitor__lmp_send_handler(_binding);
    
    return(SYS_ERR_OK);
}

static  errval_t monitor_bind_udn_reply_client__lmp_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    // store message number and arguments
    _binding->tx_msgnum = monitor_bind_udn_reply_client__msgnum;
    _binding->tx_msg_fragment = 0;
    ((_binding->tx_union).bind_udn_reply_client).mon_id = mon_id;
    ((_binding->tx_union).bind_udn_reply_client).conn_id = conn_id;
    ((_binding->tx_union).bind_udn_reply_client).err = err;
    ((_binding->tx_union).bind_udn_reply_client).notify = notify;
    ((_binding->tx_union).bind_udn_reply_client).core_id = core_id;
    ((_binding->tx_union).bind_udn_reply_client).chan_id = chan_id;
    ((_binding->tx_union).bind_udn_reply_client).asid = asid;
    FL_DEBUG("lmp TX monitor.bind_udn_reply_client\n");
    
    // try to send!
    monitor_bind_udn_reply_client__lmp_send_handler(_binding);
...
static  struct monitor_tx_vtbl monitor_lmp_tx_vtbl = {
    ...
    .bind_udn_client_request = monitor_bind_udn_client_request__lmp_send,
    .bind_udn_service_request = monitor_bind_udn_service_request__lmp_send,
    .bind_udn_reply_monitor = monitor_bind_udn_reply_monitor__lmp_send,
    .bind_udn_reply_client = monitor_bind_udn_reply_client__lmp_send,
    ...
    do {
        ...
        case monitor_alloc_iref_reply__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).alloc_iref_reply).iref = ((msg.words)[2]);
                ((_binding->rx_union).alloc_iref_reply).err = ((msg.words)[3]);
        ...
        case monitor_boot_core_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).boot_core_request).hwid = ((msg.words)[1]);
                ((_binding->rx_union).boot_core_request).type = ((msg.words)[2]);
        ...
        case monitor_bind_lmp_client_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).bind_lmp_client_request).iref = ((msg.words)[1]);
                ((_binding->rx_union).bind_lmp_client_request).conn_id = ((msg.words)[2]);
                ((_binding->rx_union).bind_lmp_client_request).buflen = ((msg.words)[3]);
        ...
        case monitor_multiboot_cap_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).multiboot_cap_request).slot = ((msg.words)[1]);
        ...
        case monitor_bind_ump_client_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).bind_ump_client_request).iref = ((msg.words)[1]);
                ((_binding->rx_union).bind_ump_client_request).conn_id = ((msg.words)[2]);
                ((_binding->rx_union).bind_ump_client_request).channel_length_in = ((msg.words)[3]);
                ((_binding->rx_union).bind_ump_client_request).channel_length_out = ((msg.words)[4]);
        ...
        case monitor_bind_ump_reply_client__msgnum:
            ...
            break;
        case monitor_bind_udn_client_request__msgnum:
            switch (_binding->rx_msg_fragment) {
            case 0:
                // check length
                if (((msg.buf).msglen) != 6) {
                ...
                ((_binding->rx_union).bind_udn_client_request).iref = ((msg.words)[1]);
                ((_binding->rx_union).bind_udn_client_request).conn_id = ((msg.words)[2]);
                ((_binding->rx_union).bind_udn_client_request).core_id = ((msg.words)[3]);
                ((_binding->rx_union).bind_udn_client_request).chan_id = ((msg.words)[4]);
                ((_binding->rx_union).bind_udn_client_request).asid = ((msg.words)[5]);
                ((_binding->rx_union).bind_udn_client_request).notify = cap;
                
                FL_DEBUG("lmp RX monitor.bind_udn_client_request\n");
                assert(((_binding->rx_vtbl).bind_udn_client_request) != NULL);
                ((_binding->rx_vtbl).bind_udn_client_request)(_binding, ((_binding->rx_union).bind_udn_client_request).iref, ((_binding->rx_union).bind_udn_client_request).conn_id, ((_binding->rx_union).bind_udn_client_request).notify, ((_binding->rx_union).bind_udn_client_request).core_id, ((_binding->rx_union).bind_udn_client_request).chan_id, ((_binding->rx_union).bind_udn_client_request).asid);
                _binding->rx_msgnum = 0;
                break;
            default:
                (_binding->error_handler)(_binding, FLOUNDER_ERR_INVALID_STATE);
            ...
            break;
        case monitor_bind_udn_service_request__msgnum:
            switch (_binding->rx_msg_fragment) {
            case 0:
                // check length
                if (((msg.buf).msglen) != 6) {
                ...
                ((_binding->rx_union).bind_udn_service_request).service_id = ((msg.words)[1]);
                ((_binding->rx_union).bind_udn_service_request).mon_id = ((msg.words)[2]);
                ((_binding->rx_union).bind_udn_service_request).core_id = ((msg.words)[3]);
                ((_binding->rx_union).bind_udn_service_request).chan_id = ((msg.words)[4]);
                ((_binding->rx_union).bind_udn_service_request).asid = ((msg.words)[5]);
                ((_binding->rx_union).bind_udn_service_request).notify = cap;
                
                FL_DEBUG("lmp RX monitor.bind_udn_service_request\n");
                assert(((_binding->rx_vtbl).bind_udn_service_request) != NULL);
                ((_binding->rx_vtbl).bind_udn_service_request)(_binding, ((_binding->rx_union).bind_udn_service_request).service_id, ((_binding->rx_union).bind_udn_service_request).mon_id, ((_binding->rx_union).bind_udn_service_request).notify, ((_binding->rx_union).bind_udn_service_request).core_id, ((_binding->rx_union).bind_udn_service_request).chan_id, ((_binding->rx_union).bind_udn_service_request).asid);
                _binding->rx_msgnum = 0;
                break;
            default:
                (_binding->error_handler)(_binding, FLOUNDER_ERR_INVALID_STATE);
            ...
            break;
        case monitor_bind_udn_reply_monitor__msgnum:
            switch (_binding->rx_msg_fragment) {
            case 0:
                // check length
                if (((msg.buf).msglen) != 7) {
                ...
                ((_binding->rx_union).bind_udn_reply_monitor).mon_id = ((msg.words)[1]);
                ((_binding->rx_union).bind_udn_reply_monitor).conn_id = ((msg.words)[2]);
                ((_binding->rx_union).bind_udn_reply_monitor).err = ((msg.words)[3]);
                ((_binding->rx_union).bind_udn_reply_monitor).core_id = ((msg.words)[4]);
                ((_binding->rx_union).bind_udn_reply_monitor).chan_id = ((msg.words)[5]);
                ((_binding->rx_union).bind_udn_reply_monitor).asid = ((msg.words)[6]);
                ((_binding->rx_union).bind_udn_reply_monitor).notify = cap;
                
                FL_DEBUG("lmp RX monitor.bind_udn_reply_monitor\n");
                assert(((_binding->rx_vtbl).bind_udn_reply_monitor) != NULL);
                ((_binding->rx_vtbl).bind_udn_reply_monitor)(_binding, ((_binding->rx_union).bind_udn_reply_monitor).mon_id, ((_binding->rx_union).bind_udn_reply_monitor).conn_id, ((_binding->rx_union).bind_udn_reply_monitor).err, ((_binding->rx_union).bind_udn_reply_monitor).notify, ((_binding->rx_union).bind_udn_reply_monitor).core_id, ((_binding->rx_union).bind_udn_reply_monitor).chan_id, ((_binding->rx_union).bind_udn_reply_monitor).asid);
                _binding->rx_msgnum = 0;
                break;
            default:
                (_binding->error_handler)(_binding, FLOUNDER_ERR_INVALID_STATE);
            ...
            break;
        case monitor_bind_udn_reply_client__msgnum:
            switch (_binding->rx_msg_fragment) {
            case 0:
                // check length
                if (((msg.buf).msglen) != 7) {
                ...
                ((_binding->rx_union).bind_udn_reply_client).mon_id = ((msg.words)[1]);
                ((_binding->rx_union).bind_udn_reply_client).conn_id = ((msg.words)[2]);
                ((_binding->rx_union).bind_udn_reply_client).err = ((msg.words)[3]);
                ((_binding->rx_union).bind_udn_reply_client).core_id = ((msg.words)[4]);
                ((_binding->rx_union).bind_udn_reply_client).chan_id = ((msg.words)[5]);
                ((_binding->rx_union).bind_udn_reply_client).asid = ((msg.words)[6]);
                ((_binding->rx_union).bind_udn_reply_client).notify = cap;
                
                FL_DEBUG("lmp RX monitor.bind_udn_reply_client\n");
                assert(((_binding->rx_vtbl).bind_udn_reply_client) != NULL);
                ((_binding->rx_vtbl).bind_udn_reply_client)(_binding, ((_binding->rx_union).bind_udn_reply_client).mon_id, ((_binding->rx_union).bind_udn_reply_client).conn_id, ((_binding->rx_union).bind_udn_reply_client).err, ((_binding->rx_union).bind_udn_reply_client).notify, ((_binding->rx_union).bind_udn_reply_client).core_id, ((_binding->rx_union).bind_udn_reply_client).chan_id, ((_binding->rx_union).bind_udn_reply_client).asid);
                _binding->rx_msgnum = 0;
                break;
            default:
                (_binding->error_handler)(_binding, FLOUNDER_ERR_INVALID_STATE);
        ...
        case monitor_get_mem_iref_reply__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).get_mem_iref_reply).iref = ((msg.words)[1]);
        ...
        case monitor_get_name_iref_reply__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).get_name_iref_reply).iref = ((msg.words)[1]);
                ((_binding->rx_union).get_name_iref_reply).st = ((msg.words)[2]);
        ...
        case monitor_get_ramfs_iref_reply__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).get_ramfs_iref_reply).iref = ((msg.words)[1]);
                ((_binding->rx_union).get_ramfs_iref_reply).st = ((msg.words)[2]);
        ...
        case monitor_set_ramfs_iref_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).set_ramfs_iref_request).iref = ((msg.words)[1]);
        ...
        case monitor_set_mem_iref_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).set_mem_iref_request).iref = ((msg.words)[1]);
        ...
        case monitor_set_name_iref_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).set_name_iref_request).iref = ((msg.words)[1]);
        ...
        case monitor_get_monitor_rpc_iref_reply__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).get_monitor_rpc_iref_reply).iref = ((msg.words)[1]);
                ((_binding->rx_union).get_monitor_rpc_iref_reply).st = ((msg.words)[2]);
        ...
        case monitor_cap_send_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).cap_send_request).capid = ((msg.words)[2]);
        ...
        case monitor_cap_receive_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).cap_receive_request).capid = ((msg.words)[3]);
        ...
        case monitor_multihop_bind_client_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).multihop_bind_client_request).iref = ((msg.words)[1]);
                ((_binding->rx_union).multihop_bind_client_request).sender_vci = ((msg.words)[2]);
                ((_binding->rx_union).multihop_bind_client_request).sender_vci = ((((_binding->rx_union).multihop_bind_client_request).sender_vci) | (((uint64_t )((msg.words)[3])) << 32));
        ...
        case monitor_multihop_bind_client_reply__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).multihop_bind_client_reply).receiver_vci = ((((_binding->rx_union).multihop_bind_client_reply).receiver_vci) | (((uint64_t )((msg.words)[2])) << 32));
                ((_binding->rx_union).multihop_bind_client_reply).sender_vci = ((msg.words)[3]);
                ((_binding->rx_union).multihop_bind_client_reply).sender_vci = ((((_binding->rx_union).multihop_bind_client_reply).sender_vci) | (((uint64_t )((msg.words)[4])) << 32));
                ((_binding->rx_union).multihop_bind_client_reply).err = ((msg.words)[5]);
        ...
        case monitor_multihop_bind_service_request__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).multihop_bind_service_request).sender_vci = ((((_binding->rx_union).multihop_bind_service_request).sender_vci) | (((uint64_t )((msg.words)[3])) << 32));
        ...
        case monitor_multihop_bind_service_reply__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).multihop_bind_service_reply).receiver_vci = ((((_binding->rx_union).multihop_bind_service_reply).receiver_vci) | (((uint64_t )((msg.words)[2])) << 32));
                ((_binding->rx_union).multihop_bind_service_reply).sender_vci = ((msg.words)[3]);
                ((_binding->rx_union).multihop_bind_service_reply).sender_vci = ((((_binding->rx_union).multihop_bind_service_reply).sender_vci) | (((uint64_t )((msg.words)[4])) << 32));
                ((_binding->rx_union).multihop_bind_service_reply).err = ((msg.words)[5]);
        ...
        case monitor_multihop_cap_send__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).multihop_cap_send).err = ((msg.words)[3]);
                ((_binding->rx_union).multihop_cap_send).capid = ((msg.words)[4]);
        ...
        case monitor_bfscope_flush_send__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).bfscope_flush_send).iref = ((msg.words)[1]);
