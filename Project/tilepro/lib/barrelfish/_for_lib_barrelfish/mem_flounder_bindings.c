 ...
 errval_t mem_export(void *st, idc_export_callback_fn *export_cb, mem_connect_fn *connect_cb, struct waitset *ws, idc_export_flags_t flags)
{
    ...
    (e->common).udn_connect_callback = mem_udn_connect_handler;
...
static  void mem_bind_continuation_direct(void *st, errval_t err, struct mem_binding *_binding)
{
    ...
    case 4:
        ...
        #ifdef CONFIG_FLOUNDER_BACKEND_UDN
        // try next backend
        b->binding = malloc(sizeof(struct mem_udn_binding ));
        assert((b->binding) != NULL);
        err = mem_udn_bind(b->binding, b->iref, mem_bind_continuation_direct, b, b->waitset, b->flags);
        if (err_is_fail(err)) {
            free(b->binding);
            _binding = NULL;
            goto out;
...
static  void mem_bind_contination_multihop(void *st, errval_t err, struct mem_binding *_binding)
{
    ...
    case 4:
        ...
        b->binding = malloc(sizeof(struct mem_udn_binding ));
        assert((b->binding) != NULL);
        err = mem_udn_bind(b->binding, b->iref, mem_bind_contination_multihop, b, b->waitset, b->flags);
        if (err_is_fail(err)) {
            free(b->binding);
            _binding = NULL;
            goto out;
...
static  void mem_allocate_call__lmp_send_handler(void *arg)
{
    ...
    case 0:
        err = lmp_chan_send5(&(b->chan), b->flags, NULL_CAP, mem_allocate_call__msgnum | (((uintptr_t )(((_binding->tx_union).allocate_call).bits)) << 16), ((_binding->tx_union).allocate_call).minbase, (((_binding->tx_union).allocate_call).minbase) >> 32, ((_binding->tx_union).allocate_call).maxlimit, (((_binding->tx_union).allocate_call).maxlimit) >> 32);
        if (err_is_ok(err)) {
...
static  void mem_steal_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send5(&(b->chan), b->flags, NULL_CAP, mem_steal_call__msgnum | (((uintptr_t )(((_binding->tx_union).steal_call).bits)) << 16), ((_binding->tx_union).steal_call).minbase, (((_binding->tx_union).steal_call).minbase) >> 32, ((_binding->tx_union).steal_call).maxlimit, (((_binding->tx_union).steal_call).maxlimit) >> 32);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void mem_available_response__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send5(&(b->chan), b->flags, NULL_CAP, mem_available_response__msgnum, ((_binding->tx_union).available_response).mem_avail, (((_binding->tx_union).available_response).mem_avail) >> 32, ((_binding->tx_union).available_response).mem_total, (((_binding->tx_union).available_response).mem_total) >> 32);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void mem_free_monitor_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send3(&(b->chan), b->flags, ((_binding->tx_union).free_monitor_call).mem_cap, mem_free_monitor_call__msgnum | (((uintptr_t )(((_binding->tx_union).free_monitor_call).bits)) << 16), ((_binding->tx_union).free_monitor_call).base, (((_binding->tx_union).free_monitor_call).base) >> 32);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    do {
        ...
        case mem_allocate_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).allocate_call).minbase = ((((_binding->rx_union).allocate_call).minbase) | (((uint64_t )((msg.words)[2])) << 32));
                ((_binding->rx_union).allocate_call).maxlimit = ((msg.words)[3]);
                ((_binding->rx_union).allocate_call).maxlimit = ((((_binding->rx_union).allocate_call).maxlimit) | (((uint64_t )((msg.words)[4])) << 32));
        ...
        case mem_steal_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).steal_call).minbase = ((((_binding->rx_union).steal_call).minbase) | (((uint64_t )((msg.words)[2])) << 32));
                ((_binding->rx_union).steal_call).maxlimit = ((msg.words)[3]);
                ((_binding->rx_union).steal_call).maxlimit = ((((_binding->rx_union).steal_call).maxlimit) | (((uint64_t )((msg.words)[4])) << 32));
        ...
        case mem_available_response__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).available_response).mem_avail = ((((_binding->rx_union).available_response).mem_avail) | (((uint64_t )((msg.words)[2])) << 32));
                ((_binding->rx_union).available_response).mem_total = ((msg.words)[3]);
                ((_binding->rx_union).available_response).mem_total = ((((_binding->rx_union).available_response).mem_total) | (((uint64_t )((msg.words)[4])) << 32));
        ...
        case mem_free_monitor_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).free_monitor_call).base = ((((_binding->rx_union).free_monitor_call).base) | (((uint64_t )((msg.words)[2])) << 32));
 ...
 */
static  void mem_udn_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct mem_binding *_binding = arg;
    struct mem_udn_binding *b = arg;
    errval_t err;
    err = SYS_ERR_OK;
    ...
    case mem_allocate_call__msgnum:
        ...
        case 0:
            ...
            (msg.data)[2] = ((((_binding->tx_union).allocate_call).minbase) >> 32);
            (msg.data)[3] = (((_binding->tx_union).allocate_call).maxlimit);
            (msg.data)[4] = ((((_binding->tx_union).allocate_call).maxlimit) >> 32);
            msg.data_len = 5;
            msg.type = mem_allocate_call__msgnum;
    ...
    case mem_allocate_response__msgnum:
        ...
        case 0:
            ...
            msg.data_len = 1;
            msg.type = mem_allocate_response__msgnum;
            udn_impl_send_msg(&(((b->udn_state).chan).send_chan), &msg);
            (_binding->tx_msg_fragment)++;
    ...
    case mem_steal_call__msgnum:
        ...
        case 0:
            ...
            (msg.data)[2] = ((((_binding->tx_union).steal_call).minbase) >> 32);
            (msg.data)[3] = (((_binding->tx_union).steal_call).maxlimit);
            (msg.data)[4] = ((((_binding->tx_union).steal_call).maxlimit) >> 32);
            msg.data_len = 5;
            msg.type = mem_steal_call__msgnum;
            udn_impl_send_msg(&(((b->udn_state).chan).send_chan), &msg);
            (_binding->tx_msg_fragment)++;
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
    ...
    case mem_steal_response__msgnum:
        ...
        case 0:
            ...
            msg.data_len = 1;
            msg.type = mem_steal_response__msgnum;
            udn_impl_send_msg(&(((b->udn_state).chan).send_chan), &msg);
            (_binding->tx_msg_fragment)++;
            if ((((b->udn_state).capst).tx_capnum) == 2) {
                _binding->tx_msgnum = 0;
    ...
    case mem_available_call__msgnum:
        ...
        case 0:
            ...
            // send the next fragment
            msg.data_len = 0;
            msg.type = mem_available_call__msgnum;
            udn_impl_send_msg(&(((b->udn_state).chan).send_chan), &msg);
            (_binding->tx_msg_fragment)++;
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
    ...
    case mem_available_response__msgnum:
        ...
        case 0:
            ...
            (msg.data)[1] = ((((_binding->tx_union).available_response).mem_avail) >> 32);
            (msg.data)[2] = (((_binding->tx_union).available_response).mem_total);
            (msg.data)[3] = ((((_binding->tx_union).available_response).mem_total) >> 32);
            msg.data_len = 4;
            msg.type = mem_available_response__msgnum;
            udn_impl_send_msg(&(((b->udn_state).chan).send_chan), &msg);
            (_binding->tx_msg_fragment)++;
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
    ...
    case mem_free_monitor_call__msgnum:
        ...
        case 0:
            ...
            (msg.data)[2] = ((((_binding->tx_union).free_monitor_call).base) >> 32);
            msg.data_len = 3;
            msg.type = mem_free_monitor_call__msgnum;
            udn_impl_send_msg(&(((b->udn_state).chan).send_chan), &msg);
            (_binding->tx_msg_fragment)++;
            if ((((b->udn_state).capst).tx_capnum) == 2) {
                _binding->tx_msgnum = 0;
    ...
    case mem_free_monitor_response__msgnum:
        ...
        case 0:
            ...
            msg.data_len = 1;
            msg.type = mem_free_monitor_response__msgnum;
            udn_impl_send_msg(&(((b->udn_state).chan).send_chan), &msg);
            (_binding->tx_msg_fragment)++;
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
 ...
 */
static  void mem_udn_cap_send_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct mem_binding *_binding = arg;
    struct mem_udn_binding *b = arg;
    ...
    case mem_allocate_response__msgnum:
        ...
        case 0:
            err = flounder_stub_send_cap(&((b->udn_state).capst), ((b->udn_state).chan).monitor_binding, ((b->udn_state).chan).monitor_id, ((_binding->tx_union).allocate_response).mem_cap, true, mem_udn_cap_send_handler);
            if (err_is_fail(err)) {
                (_binding->error_handler)(_binding, err);
                _binding->tx_msgnum = 0;
                flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    case mem_steal_response__msgnum:
        ...
        switch (((b->udn_state).capst).tx_capnum) {
        case 0:
            err = flounder_stub_send_cap(&((b->udn_state).capst), ((b->udn_state).chan).monitor_binding, ((b->udn_state).chan).monitor_id, ((_binding->tx_union).steal_response).mem_cap, true, mem_udn_cap_send_handler);
            if (err_is_fail(err)) {
                (_binding->error_handler)(_binding, err);
                _binding->tx_msgnum = 0;
                flounder_support_trigger_chan(&(_binding->register_chanstate));
    ...
    case mem_free_monitor_call__msgnum:
        ...
        switch (((b->udn_state).capst).tx_capnum) {
        case 0:
            err = flounder_stub_send_cap(&((b->udn_state).capst), ((b->udn_state).chan).monitor_binding, ((b->udn_state).chan).monitor_id, ((_binding->tx_union).free_monitor_call).mem_cap, true, mem_udn_cap_send_handler);
            if (err_is_fail(err)) {
                (_binding->error_handler)(_binding, err);
                _binding->tx_msgnum = 0;
                flounder_support_trigger_chan(&(_binding->register_chanstate));
 ...
 * Receive handler
 */
 void mem_udn_rx_handler(void *arg)
{
    // Get the binding state from our argument pointer
    struct mem_binding *_binding = arg;
    struct mem_udn_binding *b = arg;
    ...
    while (true) {
        ...
        case mem_allocate_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).allocate_call).minbase = ((((_binding->rx_union).allocate_call).minbase) | (((uint64_t )((msg->data)[2])) << 32));
                ((_binding->rx_union).allocate_call).maxlimit = ((msg->data)[3]);
                ((_binding->rx_union).allocate_call).maxlimit = ((((_binding->rx_union).allocate_call).maxlimit) | (((uint64_t )((msg->data)[4])) << 32));
                
                FL_DEBUG("udn RX mem.allocate_call\n");
                assert(((_binding->rx_vtbl).allocate_call) != NULL);
                ((_binding->rx_vtbl).allocate_call)(_binding, ((_binding->rx_union).allocate_call).bits, ((_binding->rx_union).allocate_call).minbase, ((_binding->rx_union).allocate_call).maxlimit);
                _binding->rx_msgnum = 0;
                break;
        ...
        case mem_allocate_response__msgnum:
            ...
            case 0:
                ...
                if ((((b->udn_state).capst).rx_capnum) == 1) {
                    FL_DEBUG("udn RX mem.allocate_response\n");
                    assert(((_binding->rx_vtbl).allocate_response) != NULL);
                    ((_binding->rx_vtbl).allocate_response)(_binding, ((_binding->rx_union).allocate_response).ret, ((_binding->rx_union).allocate_response).mem_cap);
                    _binding->rx_msgnum = 0;
                } else {
        ...
        case mem_steal_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).steal_call).minbase = ((((_binding->rx_union).steal_call).minbase) | (((uint64_t )((msg->data)[2])) << 32));
                ((_binding->rx_union).steal_call).maxlimit = ((msg->data)[3]);
                ((_binding->rx_union).steal_call).maxlimit = ((((_binding->rx_union).steal_call).maxlimit) | (((uint64_t )((msg->data)[4])) << 32));
                
                FL_DEBUG("udn RX mem.steal_call\n");
                assert(((_binding->rx_vtbl).steal_call) != NULL);
                ((_binding->rx_vtbl).steal_call)(_binding, ((_binding->rx_union).steal_call).bits, ((_binding->rx_union).steal_call).minbase, ((_binding->rx_union).steal_call).maxlimit);
                _binding->rx_msgnum = 0;
                break;
        ...
        case mem_steal_response__msgnum:
            ...
            case 0:
                ...
                (_binding->rx_msg_fragment)++;
                if ((((b->udn_state).capst).rx_capnum) == 1) {
                    FL_DEBUG("udn RX mem.steal_response\n");
                    assert(((_binding->rx_vtbl).steal_response) != NULL);
                    ((_binding->rx_vtbl).steal_response)(_binding, ((_binding->rx_union).steal_response).ret, ((_binding->rx_union).steal_response).mem_cap);
                    _binding->rx_msgnum = 0;
                } else {
        ...
        case mem_available_call__msgnum:
            ...
            case 0:
                ...
                FL_DEBUG("udn RX mem.available_call\n");
                assert(((_binding->rx_vtbl).available_call) != NULL);
                ((_binding->rx_vtbl).available_call)(_binding);
                _binding->rx_msgnum = 0;
                break;
        ...
        case mem_available_response__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).available_response).mem_avail = ((((_binding->rx_union).available_response).mem_avail) | (((uint64_t )((msg->data)[1])) << 32));
                ((_binding->rx_union).available_response).mem_total = ((msg->data)[2]);
                ((_binding->rx_union).available_response).mem_total = ((((_binding->rx_union).available_response).mem_total) | (((uint64_t )((msg->data)[3])) << 32));
                
                FL_DEBUG("udn RX mem.available_response\n");
                assert(((_binding->rx_vtbl).available_response) != NULL);
                ((_binding->rx_vtbl).available_response)(_binding, ((_binding->rx_union).available_response).mem_avail, ((_binding->rx_union).available_response).mem_total);
                _binding->rx_msgnum = 0;
                break;
        ...
        case mem_free_monitor_call__msgnum:
            ...
            case 0:
                ...
                ((_binding->rx_union).free_monitor_call).base = ((((_binding->rx_union).free_monitor_call).base) | (((uint64_t )((msg->data)[2])) << 32));
                
                (_binding->rx_msg_fragment)++;
                if ((((b->udn_state).capst).rx_capnum) == 1) {
                    FL_DEBUG("udn RX mem.free_monitor_call\n");
                    assert(((_binding->rx_vtbl).free_monitor_call) != NULL);
                    ((_binding->rx_vtbl).free_monitor_call)(_binding, ((_binding->rx_union).free_monitor_call).mem_cap, ((_binding->rx_union).free_monitor_call).base, ((_binding->rx_union).free_monitor_call).bits);
                    _binding->rx_msgnum = 0;
                } else {
        ...
        case mem_free_monitor_response__msgnum:
            ...
            case 0:
                ...
                FL_DEBUG("udn RX mem.free_monitor_response\n");
                assert(((_binding->rx_vtbl).free_monitor_response) != NULL);
                ((_binding->rx_vtbl).free_monitor_response)(_binding, ((_binding->rx_union).free_monitor_response).err);
                _binding->rx_msgnum = 0;
                break;
    ...
    err = udn_chan_register_recv(&((b->udn_state).chan), _binding->waitset, (struct event_closure){  .handler = mem_udn_rx_handler,  .arg = _binding });
    if (err_is_fail(err)) {
 ...
 */
static  void mem_udn_cap_rx_handler(void *arg, errval_t success, struct capref cap, uint32_t capid)
{
    // Get the binding state from our argument pointer
    struct mem_binding *_binding = arg;
    struct mem_udn_binding *b = arg;
 ...
 */
static  void mem_udn_monitor_mutex_cont(void *arg)
{
    struct mem_udn_binding *b = arg;
    assert(!(((b->udn_state).capst).monitor_mutex_held));
 ...
 * Message sender functions
 */
static  errval_t mem_allocate_call__udn_send(struct mem_binding *_binding, struct event_closure _continuation, uint8_t bits, mem_genpaddr_t minbase, mem_genpaddr_t maxlimit)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    ((_binding->tx_union).allocate_call).minbase = minbase;
    ((_binding->tx_union).allocate_call).maxlimit = maxlimit;
    FL_DEBUG("udn TX mem.allocate_call\n");
    
    // try to send!
    mem_udn_send_handler(_binding);
    
    return(SYS_ERR_OK);
}

static  errval_t mem_allocate_response__udn_send(struct mem_binding *_binding, struct event_closure _continuation, mem_errval_t ret, struct capref mem_cap)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    ((_binding->tx_union).allocate_response).ret = ret;
    ((_binding->tx_union).allocate_response).mem_cap = mem_cap;
    FL_DEBUG("udn TX mem.allocate_response\n");
    
    // init cap send state
    ((((struct mem_udn_binding *)(_binding))->udn_state).capst).tx_capnum = 0;
    ((((struct mem_udn_binding *)(_binding))->udn_state).capst).rx_cap_ack = false;
    ((((struct mem_udn_binding *)(_binding))->udn_state).capst).monitor_mutex_held = false;
    
    // wait to acquire the monitor binding mutex
    flounder_support_monitor_mutex_enqueue(((((struct mem_udn_binding *)(_binding))->udn_state).chan).monitor_binding, &(_binding->event_qnode), (struct event_closure){  .handler = mem_udn_monitor_mutex_cont,  .arg = _binding });
...
static  errval_t mem_steal_call__udn_send(struct mem_binding *_binding, struct event_closure _continuation, uint8_t bits, mem_genpaddr_t minbase, mem_genpaddr_t maxlimit)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    ((_binding->tx_union).steal_call).minbase = minbase;
    ((_binding->tx_union).steal_call).maxlimit = maxlimit;
    FL_DEBUG("udn TX mem.steal_call\n");
...
static  errval_t mem_steal_response__udn_send(struct mem_binding *_binding, struct event_closure _continuation, mem_errval_t ret, struct capref mem_cap)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    ((_binding->tx_union).steal_response).ret = ret;
    ((_binding->tx_union).steal_response).mem_cap = mem_cap;
    FL_DEBUG("udn TX mem.steal_response\n");
...
static  errval_t mem_available_call__udn_send(struct mem_binding *_binding, struct event_closure _continuation)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    _binding->tx_msgnum = mem_available_call__msgnum;
    _binding->tx_msg_fragment = 0;
    FL_DEBUG("udn TX mem.available_call\n");
...
static  errval_t mem_available_response__udn_send(struct mem_binding *_binding, struct event_closure _continuation, mem_genpaddr_t mem_avail, mem_genpaddr_t mem_total)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    ((_binding->tx_union).available_response).mem_avail = mem_avail;
    ((_binding->tx_union).available_response).mem_total = mem_total;
    FL_DEBUG("udn TX mem.available_response\n");
...
static  errval_t mem_free_monitor_call__udn_send(struct mem_binding *_binding, struct event_closure _continuation, struct capref mem_cap, mem_genpaddr_t base, uint8_t bits)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    ((_binding->tx_union).free_monitor_call).base = base;
    ((_binding->tx_union).free_monitor_call).bits = bits;
    FL_DEBUG("udn TX mem.free_monitor_call\n");
...
static  errval_t mem_free_monitor_response__udn_send(struct mem_binding *_binding, struct event_closure _continuation, mem_errval_t err)
{
    // check that we can accept an outgoing message
    if ((_binding->tx_msgnum) != 0) {
        return(FLOUNDER_ERR_TX_BUSY);
    ...
    _binding->tx_msg_fragment = 0;
    ((_binding->tx_union).free_monitor_response).err = err;
    FL_DEBUG("udn TX mem.free_monitor_response\n");
 ...
 * Send vtable
 */
static  struct mem_tx_vtbl mem_udn_tx_vtbl = {
    .allocate_call = mem_allocate_call__udn_send,
    .allocate_response = mem_allocate_response__udn_send,
    .steal_call = mem_steal_call__udn_send,
    .steal_response = mem_steal_response__udn_send,
    .available_call = mem_available_call__udn_send,
    .available_response = mem_available_response__udn_send,
    .free_monitor_call = mem_free_monitor_call__udn_send,
    .free_monitor_response = mem_free_monitor_response__udn_send,
};
/*
 * Control functions
 */
static  bool mem_udn_can_send(struct mem_binding *b)
{
    return((b->tx_msgnum) == 0);
}

static  errval_t mem_udn_register_send(struct mem_binding *b, struct waitset *ws, struct event_closure _continuation)
{
    return(flounder_support_register(ws, &(b->register_chanstate), _continuation, mem_udn_can_send(b)));
}

static  void mem_udn_default_error_handler(struct mem_binding *b, errval_t err)
{
    DEBUG_ERR(err, "asynchronous error in Flounder-generated mem udn binding (default handler)");
    abort();
}

static  errval_t mem_udn_change_waitset(struct mem_binding *_binding, struct waitset *ws)
{
    struct mem_udn_binding *b = (void *)(_binding);
    errval_t err;
...
static  errval_t mem_udn_control(struct mem_binding *_binding, idc_control_t control)
{
 ...
 */
 void mem_udn_destroy(struct mem_udn_binding *b)
{
    flounder_support_waitset_chanstate_destroy(&((b->b).register_chanstate));
    flounder_support_waitset_chanstate_destroy(&((b->b).tx_cont_chanstate));
 ...
 * Bind function
 */
static  void mem_udn_bind_continuation(void *st, errval_t err, struct udn_chan *chan, struct capref notify_cap)
{
    struct mem_binding *_binding = st;
    struct mem_udn_binding *b = st;
    
    if (err_is_ok(err)) {
        // notify cap ignored
        // setup cap handlers
        (((b->udn_state).chan).cap_handlers).st = b;
        (((b->udn_state).chan).cap_handlers).cap_receive_handler = mem_udn_cap_rx_handler;
        // register for receive notification
        err = udn_chan_register_recv(&((b->udn_state).chan), _binding->waitset, (struct event_closure){  .handler = mem_udn_rx_handler,  .arg = _binding });
        if (err_is_fail(err)) {
            (_binding->error_handler)(_binding, err_push(err, LIB_ERR_CHAN_REGISTER_RECV));
 ...
 errval_t mem_udn_init(struct mem_udn_binding *b, struct waitset *waitset, coreid_t dest_core_id, uint32_t out_chan_id, uint8_t dest_asid)
{
    errval_t err;
    struct mem_binding *_binding = &(b->b);
    (b->b).st = NULL;
    (b->b).waitset = waitset;
    event_mutex_init(&((b->b).mutex), waitset);
    (b->b).can_send = mem_udn_can_send;
    (b->b).register_send = mem_udn_register_send;
    (b->b).error_handler = mem_udn_default_error_handler;
    (b->b).tx_vtbl = mem_udn_tx_vtbl;
    memset(&((b->b).rx_vtbl), 0, sizeof((b->b).rx_vtbl));
    flounder_support_waitset_chanstate_init(&((b->b).register_chanstate));
    flounder_support_waitset_chanstate_init(&((b->b).tx_cont_chanstate));
    (b->b).tx_msgnum = 0;
    ...
    (b->b).change_waitset = mem_udn_change_waitset;
    (b->b).control = mem_udn_control;
    // register for receive notification
    err = udn_chan_register_recv(&((b->udn_state).chan), _binding->waitset, (struct event_closure){  .handler = mem_udn_rx_handler,  .arg = _binding });
    if (err_is_fail(err)) {
        (_binding->error_handler)(_binding, err_push(err, LIB_ERR_CHAN_REGISTER_RECV));
...
static  void mem_udn_new_monitor_binding_continuation(void *st, errval_t err, struct monitor_binding *monitor_binding)
{
    struct mem_binding *_binding = st;
    struct mem_udn_binding *b = st;
    ...
    err = udn_chan_bind(&((b->udn_state).chan), (struct udn_bind_continuation){  .handler = mem_udn_bind_continuation,  .st = b }, &(_binding->event_qnode), b->iref, monitor_binding, NULL_CAP);
 ...
 errval_t mem_udn_bind(struct mem_udn_binding *b, iref_t iref, mem_bind_continuation_fn *_continuation, void *st, struct waitset *waitset, idc_bind_flags_t flags)
{
    errval_t err;
    (b->b).st = NULL;
    (b->b).waitset = waitset;
    ...
    if (flags & IDC_BIND_FLAG_RPC_CAP_TRANSFER) {
        err = monitor_client_new_binding(mem_udn_new_monitor_binding_continuation, b, waitset, DEFAULT_LMP_BUF_WORDS);
    } else {
        err = udn_chan_bind(&((b->udn_state).chan), (struct udn_bind_continuation){  .handler = mem_udn_bind_continuation,  .st = b }, &((b->b).event_qnode), iref, get_monitor_binding(), NULL_CAP);
    }
 ...
 * Connect callback for export
 */
 errval_t mem_udn_connect_handler(void *st, struct monitor_binding *mb, uintptr_t mon_id, struct capref notify_cap, coreid_t dest_core_id, uint32_t out_chan_id, uint8_t dest_asid)
{
    struct mem_export *e = st;
    errval_t err;
    
    // allocate storage for binding
    struct mem_udn_binding *b = malloc(sizeof(struct mem_udn_binding ));
    if (b == NULL) {
        return(LIB_ERR_MALLOC_FAIL);
    }
