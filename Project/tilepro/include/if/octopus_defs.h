...
typedef uint32_t octopus_errval_t;
typedef uint32_t octopus_cycles_t;
...
typedef enum octopus_msg_enum {
    ...
    octopus_del_call__msgnum = 11,
    octopus_del_response__msgnum = 12,
    octopus_exists_call__msgnum = 13,
    octopus_exists_response__msgnum = 14,
    octopus_wait_for_call__msgnum = 15,
    octopus_wait_for_response__msgnum = 16,
    octopus_remove_trigger_call__msgnum = 17,
    octopus_remove_trigger_response__msgnum = 18,
    octopus_subscribe_call__msgnum = 19,
    octopus_subscribe_response__msgnum = 20,
    octopus_unsubscribe_call__msgnum = 21,
    octopus_unsubscribe_response__msgnum = 22,
    octopus_publish_call__msgnum = 23,
    octopus_publish_response__msgnum = 24,
    octopus_trigger__msgnum = 25,
    octopus_subscription__msgnum = 26,
    octopus_get_cap_call__msgnum = 27,
    octopus_get_cap_response__msgnum = 28,
    octopus_put_cap_call__msgnum = 29,
    octopus_put_cap_response__msgnum = 30,
    octopus_remove_cap_call__msgnum = 31,
    octopus_remove_cap_response__msgnum = 32
} octopus_msg_enum;
