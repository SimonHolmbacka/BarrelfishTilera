...
typedef uint32_t monitor_errval_t;
typedef uint32_t monitor_cycles_t;
...
typedef enum monitor_msg_enum {
    ...
    monitor_bind_udn_client_request__msgnum = 19,
    monitor_bind_udn_service_request__msgnum = 20,
    monitor_bind_udn_reply_monitor__msgnum = 21,
    monitor_bind_udn_reply_client__msgnum = 22,
    monitor_ipi_alloc_notify_request__msgnum = 23,
    monitor_ipi_alloc_notify_reply__msgnum = 24,
    monitor_get_mem_iref_request__msgnum = 25,
    monitor_get_mem_iref_reply__msgnum = 26,
    monitor_get_name_iref_request__msgnum = 27,
    monitor_get_name_iref_reply__msgnum = 28,
    monitor_get_ramfs_iref_request__msgnum = 29,
    monitor_get_ramfs_iref_reply__msgnum = 30,
    monitor_set_ramfs_iref_request__msgnum = 31,
    monitor_set_mem_iref_request__msgnum = 32,
    monitor_set_name_iref_request__msgnum = 33,
    monitor_set_name_iref_reply__msgnum = 34,
    monitor_get_monitor_rpc_iref_request__msgnum = 35,
    monitor_get_monitor_rpc_iref_reply__msgnum = 36,
    monitor_cap_send_request__msgnum = 37,
    monitor_cap_receive_request__msgnum = 38,
    monitor_span_domain_request__msgnum = 39,
    monitor_span_domain_reply__msgnum = 40,
    monitor_num_cores_request__msgnum = 41,
    monitor_num_cores_reply__msgnum = 42,
    monitor_multihop_routing_table_new__msgnum = 43,
    monitor_multihop_routing_table_set__msgnum = 44,
    monitor_multihop_bind_client_request__msgnum = 45,
    monitor_multihop_bind_client_reply__msgnum = 46,
    monitor_multihop_bind_service_request__msgnum = 47,
    monitor_multihop_bind_service_reply__msgnum = 48,
    monitor_multihop_message__msgnum = 49,
    monitor_multihop_cap_send__msgnum = 50,
    monitor_trace_prepare__msgnum = 51,
    monitor_trace_prepare_finished__msgnum = 52,
    monitor_bfscope_flush_send__msgnum = 53,
    monitor_bfscope_flush_ack__msgnum = 54
} monitor_msg_enum;
...
typedef  errval_t monitor_bind_udn_client_request__tx_method_fn(struct monitor_binding *_binding, struct event_closure _continuation, iref_t iref, uintptr_t conn_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
typedef  errval_t monitor_bind_udn_service_request__tx_method_fn(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t service_id, uintptr_t mon_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
typedef  errval_t monitor_bind_udn_reply_monitor__tx_method_fn(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
typedef  errval_t monitor_bind_udn_reply_client__tx_method_fn(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
...
typedef  void monitor_bind_udn_client_request__rx_method_fn(struct monitor_binding *_binding, iref_t iref, uintptr_t conn_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
typedef  void monitor_bind_udn_service_request__rx_method_fn(struct monitor_binding *_binding, uintptr_t service_id, uintptr_t mon_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
typedef  void monitor_bind_udn_reply_monitor__rx_method_fn(struct monitor_binding *_binding, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
typedef  void monitor_bind_udn_reply_client__rx_method_fn(struct monitor_binding *_binding, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid);
...
struct monitor_bind_udn_client_request__args {
    iref_t iref;
    uintptr_t conn_id;
    struct capref notify;
    uintptr_t core_id;
...
struct monitor_bind_udn_service_request__args {
    uintptr_t service_id;
    uintptr_t mon_id;
    struct capref notify;
    uintptr_t core_id;
...
struct monitor_bind_udn_reply_monitor__args {
    uintptr_t mon_id;
    uintptr_t conn_id;
    monitor_errval_t err;
    struct capref notify;
...
struct monitor_bind_udn_reply_client__args {
    uintptr_t mon_id;
    uintptr_t conn_id;
    monitor_errval_t err;
    struct capref notify;
...
union monitor_arg_union {
    ...
    struct monitor_bind_udn_client_request__args bind_udn_client_request;
    struct monitor_bind_udn_service_request__args bind_udn_service_request;
    struct monitor_bind_udn_reply_monitor__args bind_udn_reply_monitor;
    struct monitor_bind_udn_reply_client__args bind_udn_reply_client;
...
struct monitor_tx_vtbl {
    ...
    monitor_bind_udn_client_request__tx_method_fn *bind_udn_client_request;
    monitor_bind_udn_service_request__tx_method_fn *bind_udn_service_request;
    monitor_bind_udn_reply_monitor__tx_method_fn *bind_udn_reply_monitor;
    monitor_bind_udn_reply_client__tx_method_fn *bind_udn_reply_client;
...
struct monitor_rx_vtbl {
    ...
    monitor_bind_udn_client_request__rx_method_fn *bind_udn_client_request;
    monitor_bind_udn_service_request__rx_method_fn *bind_udn_service_request;
    monitor_bind_udn_reply_monitor__rx_method_fn *bind_udn_reply_monitor;
    monitor_bind_udn_reply_client__rx_method_fn *bind_udn_reply_client;
...
static inline errval_t monitor_bind_udn_client_request__tx(struct monitor_binding *_binding, struct event_closure _continuation, iref_t iref, uintptr_t conn_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid) __attribute__ ((always_inline));
static inline errval_t monitor_bind_udn_client_request__tx(struct monitor_binding *_binding, struct event_closure _continuation, iref_t iref, uintptr_t conn_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    return(((_binding->tx_vtbl).bind_udn_client_request)(_binding, _continuation, iref, conn_id, notify, core_id, chan_id, asid));
}

static inline errval_t monitor_bind_udn_service_request__tx(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t service_id, uintptr_t mon_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid) __attribute__ ((always_inline));
static inline errval_t monitor_bind_udn_service_request__tx(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t service_id, uintptr_t mon_id, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    return(((_binding->tx_vtbl).bind_udn_service_request)(_binding, _continuation, service_id, mon_id, notify, core_id, chan_id, asid));
}

static inline errval_t monitor_bind_udn_reply_monitor__tx(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid) __attribute__ ((always_inline));
static inline errval_t monitor_bind_udn_reply_monitor__tx(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    return(((_binding->tx_vtbl).bind_udn_reply_monitor)(_binding, _continuation, mon_id, conn_id, err, notify, core_id, chan_id, asid));
}

static inline errval_t monitor_bind_udn_reply_client__tx(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid) __attribute__ ((always_inline));
static inline errval_t monitor_bind_udn_reply_client__tx(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, uintptr_t conn_id, monitor_errval_t err, struct capref notify, uintptr_t core_id, uintptr_t chan_id, uintptr_t asid)
{
    return(((_binding->tx_vtbl).bind_udn_reply_client)(_binding, _continuation, mon_id, conn_id, err, notify, core_id, chan_id, asid));
}
