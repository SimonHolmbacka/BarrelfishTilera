...
typedef uint32_t monitor_blocking_errval_t;
typedef uint32_t monitor_blocking_cycles_t;
...
typedef enum monitor_blocking_msg_enum {
    ...
    monitor_blocking_get_arch_core_id_call__msgnum = 27,
    monitor_blocking_get_arch_core_id_response__msgnum = 28,
    monitor_blocking_dump_hw_ptables_call__msgnum = 29,
    monitor_blocking_dump_hw_ptables_response__msgnum = 30
...
typedef  errval_t monitor_blocking_dump_hw_ptables_call__tx_method_fn(struct monitor_blocking_binding *_binding, struct event_closure _continuation, struct capref dispatcher);
typedef  errval_t monitor_blocking_dump_hw_ptables_response__tx_method_fn(struct monitor_blocking_binding *_binding, struct event_closure _continuation);
...
typedef  void monitor_blocking_dump_hw_ptables_call__rx_method_fn(struct monitor_blocking_binding *_binding, struct capref dispatcher);
typedef  void monitor_blocking_dump_hw_ptables_response__rx_method_fn(struct monitor_blocking_binding *_binding);
...
struct monitor_blocking_dump_hw_ptables_call__args {
    struct capref dispatcher;
};
...
union monitor_blocking_arg_union {
    ...
    struct monitor_blocking_dump_hw_ptables_call__args dump_hw_ptables_call;
};
...
struct monitor_blocking_tx_vtbl {
    ...
    monitor_blocking_dump_hw_ptables_call__tx_method_fn *dump_hw_ptables_call;
    monitor_blocking_dump_hw_ptables_response__tx_method_fn *dump_hw_ptables_response;
};
...
struct monitor_blocking_rx_vtbl {
    ...
    monitor_blocking_dump_hw_ptables_call__rx_method_fn *dump_hw_ptables_call;
    monitor_blocking_dump_hw_ptables_response__rx_method_fn *dump_hw_ptables_response;
};
...
static inline errval_t monitor_blocking_dump_hw_ptables_call__tx(struct monitor_blocking_binding *_binding, struct event_closure _continuation, struct capref dispatcher) __attribute__ ((always_inline));
static inline errval_t monitor_blocking_dump_hw_ptables_call__tx(struct monitor_blocking_binding *_binding, struct event_closure _continuation, struct capref dispatcher)
{
    return(((_binding->tx_vtbl).dump_hw_ptables_call)(_binding, _continuation, dispatcher));
}

static inline errval_t monitor_blocking_dump_hw_ptables_response__tx(struct monitor_blocking_binding *_binding, struct event_closure _continuation) __attribute__ ((always_inline));
static inline errval_t monitor_blocking_dump_hw_ptables_response__tx(struct monitor_blocking_binding *_binding, struct event_closure _continuation)
{
    return(((_binding->tx_vtbl).dump_hw_ptables_response)(_binding, _continuation));
}
...
#include <if/monitor_blocking_udn_defs.h>
