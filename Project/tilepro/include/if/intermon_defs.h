...
typedef uint32_t intermon_errval_t;
typedef uint32_t intermon_cycles_t;
...
typedef enum intermon_msg_enum {
    ...
    intermon_bind_udn_request__msgnum = 26,
    intermon_bind_udn_reply__msgnum = 27,
    intermon_cap_send_request__msgnum = 28,
    intermon_span_domain_request__msgnum = 29,
    intermon_span_domain_reply__msgnum = 30,
    intermon_rsrc_join__msgnum = 31,
    intermon_rsrc_join_complete__msgnum = 32,
    intermon_rsrc_phase_data__msgnum = 33,
    intermon_rsrc_timer_sync__msgnum = 34,
    intermon_rsrc_timer_sync_reply__msgnum = 35,
    intermon_rsrc_phase__msgnum = 36,
    intermon_multihop_routing_table_request__msgnum = 37,
    intermon_multihop_routing_table_response__msgnum = 38,
    intermon_multihop_routing_table_grow__msgnum = 39,
    intermon_bind_multihop_intermon_request__msgnum = 40,
    intermon_bind_multihop_intermon_reply__msgnum = 41,
    intermon_multihop_message__msgnum = 42,
    intermon_multihop_cap_send__msgnum = 43,
    intermon_trace_prepare__msgnum = 44,
    intermon_trace_prepare_finished__msgnum = 45,
    intermon_trace_measure__msgnum = 46,
    intermon_trace_measure_ack__msgnum = 47,
    intermon_bfscope_flush_send_forward__msgnum = 48,
    intermon_bfscope_flush_ack_forward__msgnum = 49
} intermon_msg_enum;
...
typedef  errval_t intermon_bind_udn_request__tx_method_fn(struct intermon_binding *_binding, struct event_closure _continuation, iref_t iref, intermon_mon_id_t_t mon_id, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid);
typedef  errval_t intermon_bind_udn_reply__tx_method_fn(struct intermon_binding *_binding, struct event_closure _continuation, intermon_con_id_t_t con_id, intermon_mon_id_t_t mon_id, intermon_errval_t err, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid);
...
typedef  void intermon_bind_udn_request__rx_method_fn(struct intermon_binding *_binding, iref_t iref, intermon_mon_id_t_t mon_id, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid);
typedef  void intermon_bind_udn_reply__rx_method_fn(struct intermon_binding *_binding, intermon_con_id_t_t con_id, intermon_mon_id_t_t mon_id, intermon_errval_t err, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid);
...
struct intermon_bind_udn_request__args {
    iref_t iref;
    intermon_mon_id_t_t mon_id;
    intermon_caprep_t notify;
    intermon_coreid_t_t core_id;
...
struct intermon_bind_udn_reply__args {
    intermon_con_id_t_t con_id;
    intermon_mon_id_t_t mon_id;
    intermon_errval_t err;
    intermon_caprep_t notify;
...
union intermon_arg_union {
    ...
    struct intermon_bind_udn_request__args bind_udn_request;
    struct intermon_bind_udn_reply__args bind_udn_reply;
...
struct intermon_tx_vtbl {
    ...
    intermon_bind_udn_request__tx_method_fn *bind_udn_request;
    intermon_bind_udn_reply__tx_method_fn *bind_udn_reply;
...
struct intermon_rx_vtbl {
    ...
    intermon_bind_udn_request__rx_method_fn *bind_udn_request;
    intermon_bind_udn_reply__rx_method_fn *bind_udn_reply;
...
static inline errval_t intermon_bind_udn_request__tx(struct intermon_binding *_binding, struct event_closure _continuation, iref_t iref, intermon_mon_id_t_t mon_id, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid) __attribute__ ((always_inline));
static inline errval_t intermon_bind_udn_request__tx(struct intermon_binding *_binding, struct event_closure _continuation, iref_t iref, intermon_mon_id_t_t mon_id, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid)
{
    return(((_binding->tx_vtbl).bind_udn_request)(_binding, _continuation, iref, mon_id, notify, core_id, chan_id, asid));
}

static inline errval_t intermon_bind_udn_reply__tx(struct intermon_binding *_binding, struct event_closure _continuation, intermon_con_id_t_t con_id, intermon_mon_id_t_t mon_id, intermon_errval_t err, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid) __attribute__ ((always_inline));
static inline errval_t intermon_bind_udn_reply__tx(struct intermon_binding *_binding, struct event_closure _continuation, intermon_con_id_t_t con_id, intermon_mon_id_t_t mon_id, intermon_errval_t err, intermon_caprep_t notify, intermon_coreid_t_t core_id, intermon_chanid_t_t chan_id, uint8_t asid)
{
    return(((_binding->tx_vtbl).bind_udn_reply)(_binding, _continuation, con_id, mon_id, err, notify, core_id, chan_id, asid));
}
...
#include <if/intermon_udn_defs.h>
