...
typedef  errval_t monitor_blocking_dump_hw_ptables__rpc_method_fn(struct monitor_blocking_rpc_client *_rpc, struct capref dispatcher);
...
struct monitor_blocking_rpc_vtbl {
    ...
    monitor_blocking_dump_hw_ptables__rpc_method_fn *dump_hw_ptables;
};
