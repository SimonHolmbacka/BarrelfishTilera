...
struct VNode_ARM_l1;
struct VNode_ARM_l2;
struct VNode_tilepro_l1;
struct VNode_tilepro_l2;
...
enum objtype {
    ...
    ObjType_PerfMon = 26,
    ObjType_ID = 25,
    ObjType_Notify_IPI = 24,
    ObjType_Notify_RCK = 23,
    ObjType_IO = 22,
    ObjType_IRQTable = 21,
    ObjType_VNode_tilepro_l2 = 20,
    ObjType_VNode_tilepro_l1 = 19,
...
struct VNode_tilepro_l1 {genpaddr_t base;};
struct VNode_tilepro_l2 {genpaddr_t base;};
struct IRQTable {};
...
union capability_u {struct  Null null;
                    ...
                    struct  VNode_tilepro_l1 vnode_tilepro_l1;
                    struct  VNode_tilepro_l2 vnode_tilepro_l2;
