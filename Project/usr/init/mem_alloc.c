...
#ifdef __tilepro__
// here we increase the required ram space for mem_serv, the previous 16MB is not enough,
// because tilera's page size is much larger than other archs, e.g. ARM and X86.
#define MM_REQUIREDBITS    25          ///< Required size of memory to boot (32MB)
#else
