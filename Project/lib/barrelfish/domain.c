...
uint8_t get_tile_width(void)
{
	dispatcher_handle_t handle = curdispatcher();
	return dispatcher_tilepro_get_tile_width(handle);
}

uint8_t get_tile_height(void)
{
	dispatcher_handle_t handle = curdispatcher();
	return dispatcher_tilepro_get_tile_height(handle);
}

uint32_t get_new_in_chan_id(void)
{
	dispatcher_handle_t handle = curdispatcher();
	return dispatcher_tilepro_get_in_chan_id(handle);
}

uint8_t get_asid(void)
{
	dispatcher_handle_t handle = curdispatcher();
	return dispatcher_tilepro_get_asid(handle);
}
