...
allArchitectures = [ "x86_64", "x86_32", "armv5", "arm11mp", "scc", "xscale", "armv7", "tilepro" ]
allArchitectureFamilies = [ "x86_64", "x86_32", "arm", "scc", "tilepro" ]
...
allFlounderBackends
    = [ "lmp", "ump", "ump_ipi", "loopback", "rpcclient", "msgbuf", "multihop", "ahci", "udn" ]
