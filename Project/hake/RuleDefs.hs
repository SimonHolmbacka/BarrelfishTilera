...
options "tilepro" = TilePro.options
...
kernelCFlags "tilepro" = TilePro.kernelCFlags
...
kernelLdFlags "tilepro" = TilePro.kernelLdFlags
...
cCompiler opts phase src obj
    ...
    | optArch opts == "tilepro" = TilePro.cCompiler opts phase src obj
...
makeDepend opts phase src obj depfile
    ...
    | optArch opts == "tilepro" =
        TilePro.makeDepend opts phase src obj depfile
...
cToAssembler opts phase src afile objdepfile
    ...
    | optArch opts == "tilepro"  = TilePro.cToAssembler opts phase src afile objdepfile
    | otherwise = [ ErrorMsg ("no C compiler for " ++ (optArch opts)) ]
...
assembler opts src obj
    ...
    | optArch opts == "tilepro" = TilePro.assembler opts src obj
...
archive opts objs libs name libname
    ...
    | optArch opts == "tilepro" = TilePro.archive opts objs libs name libname
...
linker opts objs libs bin
    ...
    | optArch opts == "tilepro" = TilePro.linker opts objs libs bin
...
linkKernel opts name objs libs
    ...
    | optArch opts == "tilepro" = TilePro.linkKernel opts objs [libraryPath l | l <- libs ] kernelPath
