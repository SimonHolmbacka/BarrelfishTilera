...
#define KILL_CALLEE_SAVES assert(0 && "THC not yet implemented on Tilepro")
#else
...
#elif defined(__tilepro__)
#define FORCE_ARGS_STACK assert(0 && "THC not yet implemented on Tilepro")
#define FORCE_ARGS_STACK_CALL assert(0 && "THC not yet implemented on Tilepro")
#else
...
#elif defined(__tilepro__)
#define GET_STACK_POINTER(_) assert(0 && "THC not yet implemented on Tilepro")
#define RESTORE_OLD_STACK_POINTER(_) assert(0 && "THC not yet implemented on Tilepro")
#else
...
#elif defined(__tilepro__)
#define INIT_LAZY_AWE(_) assert(0 && "THC not yet implemented on Tilepro")
#define RETURN_CONT(_) assert(0 && "THC not yet implemented on Tilepro")
#define GET_LAZY_AWE(_) assert(0 && "THC not yet implemented on Tilepro")
#else
