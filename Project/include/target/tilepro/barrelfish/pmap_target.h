...
#ifndef TARGET_TILEPRO_BARRELFISH_PMAP_H
#define TARGET_TILEPRO_BARRELFISH_PMAP_H

#include <barrelfish/pmap.h>

/// Node in the meta-data, corresponds to an actual VNode object
struct vnode {
	uint16_t entry;  ///< Index of page table entry of this VNode
...
#endif /* TARGET_TILEPRO_BARRELFISH_PMAP_H */
