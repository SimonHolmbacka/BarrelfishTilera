...
#ifdef __tilepro__
// It is possible to have 32bit pointers (virtual space) and up to 64bits of physical space.
// Especially with a massive amount of cores, a big physical space can be handled
// with only 32bits per core.
typedef unsigned long long lpaddr_t;
#define PRIuLPADDR PRIu64
