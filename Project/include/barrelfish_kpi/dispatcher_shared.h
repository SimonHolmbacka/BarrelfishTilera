 ...
 */
#ifdef __tilepro__
// here we define tilepro-related DISPATCHER_SIZE, which is 2MB, and give up the size defined by BF, which is 256KB.
// the main reason is, the structure dispatcher_tilepro in our case is bigger than 256KB,
// because we have more registers need to save in this structure, so 2MB (21 bits) should be enough.
#define DISPATCHER_FRAME_BITS 21
#else
