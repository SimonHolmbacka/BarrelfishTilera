...
#ifdef __tilepro__
// here we keep this as same as other archs, otherwise code crashes.
#define PAGE_CNODE_BITS         (DEFAULT_CNODE_BITS)
#else
...
#ifdef __tilepro__
// special case for tilepro, only in this case, it works
#define SLOT_ALLOC_CNODE_BITS   (DEFAULT_CNODE_BITS)
#else
